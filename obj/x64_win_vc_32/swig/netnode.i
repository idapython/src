%module(docstring="IDA Plugin SDK API wrapper: netnode",directors="1",threads="1") ida_netnode
#ifndef IDA_MODULE_DEFINED
  #define IDA_MODULE_NETNODE
#define IDA_MODULE_DEFINED
#endif // IDA_MODULE_DEFINED
#ifndef HAS_DEP_ON_INTERFACE_NETNODE
  #define HAS_DEP_ON_INTERFACE_NETNODE
#endif
%include "header.i"
%ignore RootNode;
...
%extend netnode
{
    ...
    bool hashset_buf(const char *idx, PyObject *py_str, char tag=htag)
    {
      char *buf;
      Py_ssize_t sz;
      if ( IDAPyBytes_AsMemAndSize(py_str, &buf, &sz) == -1 )
        return false;
