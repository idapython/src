%module(docstring="IDA Plugin SDK API wrapper: strlist",directors="1",threads="1") ida_strlist
#ifndef IDA_MODULE_DEFINED
  #define IDA_MODULE_STRLIST
#define IDA_MODULE_DEFINED
#endif // IDA_MODULE_DEFINED
#ifndef HAS_DEP_ON_INTERFACE_STRLIST
  #define HAS_DEP_ON_INTERFACE_STRLIST
#endif
%include "header.i"
%{
#include <strlist.hpp>
