%module(docstring="IDA Plugin SDK API wrapper: gdl",directors="1",threads="1") ida_gdl
#ifndef IDA_MODULE_DEFINED
  #define IDA_MODULE_GDL
#define IDA_MODULE_DEFINED
#endif // IDA_MODULE_DEFINED
#ifndef HAS_DEP_ON_INTERFACE_GDL
  #define HAS_DEP_ON_INTERFACE_GDL
#endif
