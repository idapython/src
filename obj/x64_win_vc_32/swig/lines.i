%module(docstring="IDA Plugin SDK API wrapper: lines",directors="1",threads="1") ida_lines
#ifndef IDA_MODULE_DEFINED
  #define IDA_MODULE_LINES
#define IDA_MODULE_DEFINED
#endif // IDA_MODULE_DEFINED
#ifndef HAS_DEP_ON_INTERFACE_LINES
  #define HAS_DEP_ON_INTERFACE_LINES
#endif
%include "header.i"
...
//<typemaps(lines)>
%typemap(check) (qstring  * buf, const char * str, int init_level)
{
if ( $2 == NULL )
