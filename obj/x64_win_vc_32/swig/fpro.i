%module(docstring="IDA Plugin SDK API wrapper: fpro",directors="1",threads="1") ida_fpro
#ifndef IDA_MODULE_DEFINED
  #define IDA_MODULE_FPRO
#define IDA_MODULE_DEFINED
#endif // IDA_MODULE_DEFINED
#ifndef HAS_DEP_ON_INTERFACE_FPRO
  #define HAS_DEP_ON_INTERFACE_FPRO
#endif
%include "header.i"
%inline %{
//<inline(py_fpro)>
