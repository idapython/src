...
/*-----------------------------------------------
              @(target):= _ida_problems.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__ida_problems

#else
#  define SWIG_init    init_ida_problems

#endif
#define SWIG_name    "_ida_problems"
...
extern "C" {
#endif
SWIGINTERN int Swig_var_PR_NOBASE_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_NOBASE is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_NOBASE_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_NOBASE));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_NONAME_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_NONAME is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_NONAME_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_NONAME));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_NOFOP_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_NOFOP is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_NOFOP_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_NOFOP));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_NOCMT_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_NOCMT is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_NOCMT_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_NOCMT));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_NOXREFS_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_NOXREFS is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_NOXREFS_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_NOXREFS));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_JUMP_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_JUMP is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_JUMP_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_JUMP));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_DISASM_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_DISASM is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_DISASM_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_DISASM));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_HEAD_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_HEAD is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_HEAD_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_HEAD));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_ILLADDR_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_ILLADDR is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_ILLADDR_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_ILLADDR));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_MANYLINES_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_MANYLINES is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_MANYLINES_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_MANYLINES));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_BADSTACK_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_BADSTACK is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_BADSTACK_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_BADSTACK));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_ATTN_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_ATTN is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_ATTN_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_ATTN));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_FINAL_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_FINAL is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_FINAL_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_FINAL));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_ROLLED_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_ROLLED is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_ROLLED_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_ROLLED));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_COLLISION_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_COLLISION is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_COLLISION_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_COLLISION));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_DECIMP_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_DECIMP is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_DECIMP_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_DECIMP));
  return pyobj;
}


SWIGINTERN int Swig_var_PR_END_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable PR_END is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_PR_END_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_unsigned_SS_char(static_cast< unsigned char >(PR_END));
  return pyobj;
}


SWIGINTERN PyObject *_wrap_get_problem_desc(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "get_problem_desc", 2, 2, swig_obj)) SWIG_fail;
  ecode2 = SWIG_AsVal_unsigned_SS_char(swig_obj[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "get_problem_desc" "', argument " "2"" of type '" "problist_id_t""'");
  } 
  arg2 = static_cast< problist_id_t >(val2);
  {
    // %typemap(in) ea_t
    uint64 arg3_temp;
    ...
    SWIG_exception_fail(
      SWIG_TypeError,
      "in method '" "get_problem_desc" "', argument " "3"" of type 'ea_t'");
    arg3 = ea_t(arg3_temp);
  }
  {
    try
    {
      result = get_problem_desc(arg1,arg2,arg3);
    }
...
SWIGINTERN PyObject *_wrap_remember_problem(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  if ( !__chkthr() ) return NULL; // patched by patch_codegen.py
  PyObject *resultobj = 0;
  ...
  if (!SWIG_Python_UnpackTuple(args, "remember_problem", 2, 3, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_unsigned_SS_char(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "remember_problem" "', argument " "1"" of type '" "problist_id_t""'");
  } 
  arg1 = static_cast< problist_id_t >(val1);
  {
    // %typemap(in) ea_t
    uint64 arg2_temp;
    ...
    SWIG_exception_fail(
      SWIG_TypeError,
      "in method '" "remember_problem" "', argument " "2"" of type 'ea_t'");
    arg2 = ea_t(arg2_temp);
  }
  if (swig_obj[2]) {
    res3 = SWIG_AsCharPtrAndSize(swig_obj[2], &buf3, NULL, &alloc3);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "remember_problem" "', argument " "3"" of type '" "char const *""'");
    }
  ...
  }
  {
    try
    {
      remember_problem(arg1,arg2,(char const *)arg3);
    }
    catch ( const std::bad_alloc &ba ) {
      __raise_ba(ba); SWIG_fail; 
    }
...
SWIGINTERN PyObject *_wrap_get_problem(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  if ( !__chkthr() ) return NULL; // patched by patch_codegen.py
  PyObject *resultobj = 0;
  ...
  if (!SWIG_Python_UnpackTuple(args, "get_problem", 2, 2, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_unsigned_SS_char(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "get_problem" "', argument " "1"" of type '" "problist_id_t""'");
  } 
  arg1 = static_cast< problist_id_t >(val1);
  {
    // %typemap(in) ea_t
    ...
    SWIG_exception_fail(
      SWIG_TypeError,
      "in method '" "get_problem" "', argument " "2"" of type 'ea_t'");
    arg2 = ea_t(arg2_temp);
  }
  {
    try
    {
      result = (ea_t)get_problem(arg1,arg2);
    }
    catch ( const std::bad_alloc &ba ) {
      __raise_ba(ba); SWIG_fail; 
    }
...
SWIGINTERN PyObject *_wrap_forget_problem(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  if ( !__chkthr() ) return NULL; // patched by patch_codegen.py
  PyObject *resultobj = 0;
  ...
  if (!SWIG_Python_UnpackTuple(args, "forget_problem", 2, 2, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_unsigned_SS_char(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "forget_problem" "', argument " "1"" of type '" "problist_id_t""'");
  } 
  arg1 = static_cast< problist_id_t >(val1);
  {
    // %typemap(in) ea_t
    ...
    SWIG_exception_fail(
      SWIG_TypeError,
      "in method '" "forget_problem" "', argument " "2"" of type 'ea_t'");
    arg2 = ea_t(arg2_temp);
  }
  {
    try
    {
      result = (bool)forget_problem(arg1,arg2);
    }
    catch ( const std::bad_alloc &ba ) {
      __raise_ba(ba); SWIG_fail; 
    }
...
SWIGINTERN PyObject *_wrap_get_problem_name(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  if ( !__chkthr() ) return NULL; // patched by patch_codegen.py
  PyObject *resultobj = 0;
  ...
  if (!SWIG_Python_UnpackTuple(args, "get_problem_name", 1, 2, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_unsigned_SS_char(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "get_problem_name" "', argument " "1"" of type '" "problist_id_t""'");
  } 
  arg1 = static_cast< problist_id_t >(val1);
  if (swig_obj[1]) {
    ecode2 = SWIG_AsVal_bool(swig_obj[1], &val2);
    if (!SWIG_IsOK(ecode2)) {
      SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "get_problem_name" "', argument " "2"" of type '" "bool""'");
    } 
  ...
  }
  {
    try
    {
      result = (char *)get_problem_name(arg1,arg2);
    }
    catch ( const std::bad_alloc &ba ) {
      __raise_ba(ba); SWIG_fail; 
    }
...
SWIGINTERN PyObject *_wrap_is_problem_present(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  if ( !__chkthr() ) return NULL; // patched by patch_codegen.py
  PyObject *resultobj = 0;
  ...
  if (!SWIG_Python_UnpackTuple(args, "is_problem_present", 2, 2, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_unsigned_SS_char(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "is_problem_present" "', argument " "1"" of type '" "problist_id_t""'");
  } 
  arg1 = static_cast< problist_id_t >(val1);
  {
    // %typemap(in) ea_t
    ...
    SWIG_exception_fail(
      SWIG_TypeError,
      "in method '" "is_problem_present" "', argument " "2"" of type 'ea_t'");
    arg2 = ea_t(arg2_temp);
  }
  {
    try
    {
      result = (bool)is_problem_present(arg1,arg2);
    }
    catch ( const std::bad_alloc &ba ) {
      __raise_ba(ba); SWIG_fail; 
    }
...
SWIGINTERN PyObject *_wrap_was_ida_decision(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  if ( !__chkthr() ) return NULL; // patched by patch_codegen.py
  PyObject *resultobj = 0;
  ...
  swig_obj[0] = args;
  {
    ...
    SWIG_exception_fail(
      SWIG_TypeError,
      "in method '" "was_ida_decision" "', argument " "1"" of type 'ea_t'");
    arg1 = ea_t(arg1_temp);
  }
  {
    try
    {
      result = (bool)was_ida_decision(arg1);
    }
    catch ( const std::bad_alloc &ba ) {
      __raise_ba(ba); SWIG_fail; 
    }
...
static PyMethodDef SwigMethods[] = {
	 { "get_problem_desc", _wrap_get_problem_desc, METH_VARARGS, "get_problem_desc(t, ea) -> ssize_t"},
	 { "remember_problem", _wrap_remember_problem, METH_VARARGS, "remember_problem(type, ea, msg=None)"},
	 { "get_problem", _wrap_get_problem, METH_VARARGS, "get_problem(type, lowea) -> ea_t"},
	 { "forget_problem", _wrap_forget_problem, METH_VARARGS, "forget_problem(type, ea) -> bool"},
	 { "get_problem_name", _wrap_get_problem_name, METH_VARARGS, "get_problem_name(type, longname=True) -> char const *"},
	 { "is_problem_present", _wrap_is_problem_present, METH_VARARGS, "is_problem_present(t, ea) -> bool"},
	 { "was_ida_decision", _wrap_was_ida_decision, METH_O, "was_ida_decision(ea) -> bool"},
	 { NULL, NULL, 0, NULL }
};
...
static swig_type_info _swigt__p_unsigned_char = {"_p_unsigned_char", "uchar *|unsigned char *|cm_t *|uint8 *|op_dtype_t *|type_t *|p_list *|reftype_t *|color_t *|bte_t *|problist_id_t *|p_string *|comp_t *", 0, 0, (void*)0, 0};
...
# endif
  ...
  Py_DECREF(globals);
  SWIG_addvarlink(globals, "PR_NOBASE", Swig_var_PR_NOBASE_get, Swig_var_PR_NOBASE_set);
  SWIG_addvarlink(globals, "PR_NONAME", Swig_var_PR_NONAME_get, Swig_var_PR_NONAME_set);
  SWIG_addvarlink(globals, "PR_NOFOP", Swig_var_PR_NOFOP_get, Swig_var_PR_NOFOP_set);
  SWIG_addvarlink(globals, "PR_NOCMT", Swig_var_PR_NOCMT_get, Swig_var_PR_NOCMT_set);
  SWIG_addvarlink(globals, "PR_NOXREFS", Swig_var_PR_NOXREFS_get, Swig_var_PR_NOXREFS_set);
  SWIG_addvarlink(globals, "PR_JUMP", Swig_var_PR_JUMP_get, Swig_var_PR_JUMP_set);
  SWIG_addvarlink(globals, "PR_DISASM", Swig_var_PR_DISASM_get, Swig_var_PR_DISASM_set);
  SWIG_addvarlink(globals, "PR_HEAD", Swig_var_PR_HEAD_get, Swig_var_PR_HEAD_set);
  SWIG_addvarlink(globals, "PR_ILLADDR", Swig_var_PR_ILLADDR_get, Swig_var_PR_ILLADDR_set);
  SWIG_addvarlink(globals, "PR_MANYLINES", Swig_var_PR_MANYLINES_get, Swig_var_PR_MANYLINES_set);
  SWIG_addvarlink(globals, "PR_BADSTACK", Swig_var_PR_BADSTACK_get, Swig_var_PR_BADSTACK_set);
  SWIG_addvarlink(globals, "PR_ATTN", Swig_var_PR_ATTN_get, Swig_var_PR_ATTN_set);
  SWIG_addvarlink(globals, "PR_FINAL", Swig_var_PR_FINAL_get, Swig_var_PR_FINAL_set);
  SWIG_addvarlink(globals, "PR_ROLLED", Swig_var_PR_ROLLED_get, Swig_var_PR_ROLLED_set);
  SWIG_addvarlink(globals, "PR_COLLISION", Swig_var_PR_COLLISION_get, Swig_var_PR_COLLISION_set);
  SWIG_addvarlink(globals, "PR_DECIMP", Swig_var_PR_DECIMP_get, Swig_var_PR_DECIMP_set);
  SWIG_addvarlink(globals, "PR_END", Swig_var_PR_END_get, Swig_var_PR_END_set);
