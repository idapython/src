...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__ida_idc

#else
#  define SWIG_init    init_ida_idc

#endif
#define SWIG_name    "_ida_idc"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_mark_position(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "mark_position", 6, 6, swig_obj)) SWIG_fail;
  {
    // %typemap(in) ea_t
    uint64 arg1_temp;
    ...
    SWIG_exception_fail(
      SWIG_TypeError,
      "in method '" "mark_position" "', argument " "1"" of type 'ea_t'");
    arg1 = ea_t(arg1_temp);
  }
  ecode2 = SWIG_AsVal_int(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "mark_position" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  ecode3 = SWIG_AsVal_short(swig_obj[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "mark_position" "', argument " "3"" of type '" "short""'");
  } 
  arg3 = static_cast< short >(val3);
  ecode4 = SWIG_AsVal_short(swig_obj[3], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "mark_position" "', argument " "4"" of type '" "short""'");
  } 
  arg4 = static_cast< short >(val4);
  ecode5 = SWIG_AsVal_int(swig_obj[4], &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "mark_position" "', argument " "5"" of type '" "int32""'");
  } 
  arg5 = static_cast< int32 >(val5);
  res6 = SWIG_AsCharPtrAndSize(swig_obj[5], &buf6, NULL, &alloc6);
  if (!SWIG_IsOK(res6)) {
    SWIG_exception_fail(SWIG_ArgError(res6), "in method '" "mark_position" "', argument " "6"" of type '" "char const *""'");
  }
  arg6 = reinterpret_cast< char * >(buf6);
  {
    try
    {
      mark_position(arg1,arg2,arg3,arg4,arg5,(char const *)arg6);
    }
...
SWIGINTERN PyObject *_wrap_get_marked_pos(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int32 arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "get_marked_pos" "', argument " "1"" of type '" "int32""'");
  } 
  arg1 = static_cast< int32 >(val1);
  {
    try
    {
      result = (ea_t)get_marked_pos(arg1);
    }
    catch ( const std::bad_alloc &ba ) {
      __raise_ba(ba); SWIG_fail; 
    }
...
SWIGINTERN PyObject *_wrap_get_mark_comment(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int32 arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  ecode1 = SWIG_AsVal_int(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "get_mark_comment" "', argument " "1"" of type '" "int32""'");
  } 
  arg1 = static_cast< int32 >(val1);
  {
    try
    {
      result = (PyObject *)get_mark_comment(arg1);
    }
    catch ( const std::bad_alloc &ba ) {
      __raise_ba(ba); SWIG_fail; 
    }
...
static PyMethodDef SwigMethods[] = {
	 { "mark_position", _wrap_mark_position, METH_VARARGS, "mark_position(ea, lnnum, x, y, slot, comment)"},
	 { "get_marked_pos", _wrap_get_marked_pos, METH_O, "get_marked_pos(slot) -> ea_t"},
	 { "get_mark_comment", _wrap_get_mark_comment, METH_O, "get_mark_comment(slot) -> PyObject *"},
	 { NULL, NULL, 0, NULL }
};
