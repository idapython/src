...
if sys.version_info.major == 3 and sys.version_info.minor <= 4:
    # Python 3.4 has everything in importlib._bootstrap
    # For some reason, idapython doesn't let us catch ImportError, so there's
    # no better solution than testing version.
